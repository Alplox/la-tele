import { BOTON_ALTERNAR_VISIBILIDAD_OVERLAY, CONTAINER_OVERLAY, CONTAINER_TRANSMISION_ACTIVA, SPAN_BOTON_ALTERNAR_VISIBILIDAD_OVERLAY, SVG_EYE_CLOSED } from "./main.js";
...
export function setupObserver() {
  const OBSERVER = new MutationObserver(() => {
    ...
    if (divs.length < 1) {
      ...
      SPAN_BOTON_ALTERNAR_VISIBILIDAD_OVERLAY.innerHTML = SVG_EYE_CLOSED;
